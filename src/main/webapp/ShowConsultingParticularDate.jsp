...
<div class="div1">
<form action="ShowConsultingParticularDate.jsp" method="get">
	<table id="table-1">
		<tr>
		<td><label for="input-1">Consulting Date :</label>
		<td><input type="date" name="date" class="inputcheck"></td>
...
try {
    ...
    request.setAttribute("parsedDate", date);
} catch (java.text.ParseException e) {
    e.printStackTrace();
}
%>
<c:set var="consultaionList" value="${consultaion.showConsultingDetailsOfParticularDate(parsedDate)}" />
