...
<a href="AddAppointmentjsp.jsp?username=<%=name%>">Add Appointment</a>
<a href="Showappoint.jsp?username=<%=name%>">Show Appointments</a>
<a href="AppointmentCancel.jsp?username=<%=name%>">Cancel Appointments</a>
