...
<a href="AddRoom.jsp?username=<%=name%>">Add Room</a>
<a href="ShowRoom.jsp?username=<%=name%>">Show Room</a>
<a href="SearchRoom.jsp?username=<%=name%>">SearchRoom(By Id/THREE/TWO/DELUX/SUITE)</a>
<a href="ShowAvailableRooms.jsp?username=<%=name%>">ShowAvailableRooms</a>
