...
<a href="AddHospital.jsp?username=<%=name%>">Add Hospital</a>
<a href="ShowHospital.jsp?username=<%=name%>">Show Hospital</a>
<a href="ShowHospitalByID.jsp?username=<%=name%>">Show HospitalBy ID</a>
<a href="ShowHospitalCity.jsp?username=<%=name%>">Show HospitalBy City</a>
