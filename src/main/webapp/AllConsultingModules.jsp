...
<a href="AddConsultingDetails.jsp?username=<%=name%>">AddConsultingDetails</a>
<a href="ShowConsultingParticularDate.jsp?username=<%=name%>">ShowConsultingDetails of Particular Date</a>
<a href="SearchConsultingDetails.jsp?username=<%=name%>">SearchConsultingDetails</a>
<a href="ShowConsultingPendingPayment.jsp?username=<%=name%>">ShowConsulting PENDING</a>
